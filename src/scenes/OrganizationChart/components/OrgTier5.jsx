...
import { Box, Typography, useMediaQuery, Grid, Autocomplete, TextField } from '@mui/material';
import MUIDataTable from "mui-datatables";
import TileBox from '../../../components/TileBox';
import '../../global/custom-table.css';


const OrgTier5 = ({input, tierInfo, objInfo, defaultFilter, theme, colors}) => {
  ...
  //TILE DATA'S
    ...
    const [ActiveCopilot, setActiveCopilot] = useState(input.filter(item => item.copilotEnabled === 'Yes').length);
    ...
    const handleSelectedTier1 = (event, newselectedTier1) => {
        ...
        if(newselectedTier1 === 'All' || newselectedTier1 === null || newselectedTier1 === '') {
            ...
            setActiveCopilot(input.filter(item => item.copilotEnabled === 'Yes').length);
        } else {
            ...
            setActiveCopilot(tile1Data.filter(item => item.copilotEnabled === 'Yes').length);
        }
    ...
    const handleSelectedTier2 = (event, newselectedTier2) => {
        ...
        if(newselectedTier2 === 'All' || newselectedTier2 === null || newselectedTier2 === '') {
            ...
            setActiveCopilot(tile2Data.filter(item => item.copilotEnabled === 'Yes').length);
        }
    ...
    const handleSelectedTier3 = (event, newselectedTier3) => {
        ...
        if(newselectedTier3 === 'All' || newselectedTier3 === null || newselectedTier3 === '') {
            ...
            setActiveCopilot(tile3Data.filter(item => item.copilotEnabled === 'Yes').length);
        }
    }
    ...
    const handleSelectedTier4 = (event, newselectedTier4) => {
        ...
        if(newselectedTier4 === 'All' || newselectedTier4 === null || newselectedTier4 === '') {
            ...
            setActiveCopilot(tile4Data.filter(item => item.copilotEnabled === 'Yes').length);
        }
    }
    ...
    const handleSelectedTier5 = (event, newselectedTier5) => {
        ...
        if(newselectedTier5 === 'All' || newselectedTier5 === null || newselectedTier5 === '') {
            ...
            setActiveCopilot(tile5Data.filter(item => item.copilotEnabled === 'Yes').length);
    ...
    const columns = [
        ...
        },
        {
            ...
            options:{
                filter: true,
                filterType: 'dropdown',
                customFilterListOptions: {render: v =>  `Copilot Enabled: ${v}`},
                setCellProps: () => ({style: {whiteSpace:'nowrap', verticalAlign: 'top'}}),
                setCellHeaderProps: () => ({style: {whiteSpace:'nowrap'}})
            }
        } 
  ...
  return (
    <Box>
        ...
        <Box
          display="flex"
          marginBottom="40px"
          sx={{ backgroundColor: colors.primary[400], width: '100%', height: 'auto', filter: 'drop-shadow(0px 4px 3px rgba(0, 0, 0, 0.2))' }}
        >                
            <Grid container>
                {/* FILTER -TIER 1 */} 
                <Grid item sx={{ 
        ...
        <Box display="flex" flexDirection="column" justifyContent="space-between" sx={{positionLeft:15, marginBottom: 5}}>
            ...
            >    
                ...
                <TileBox actionIcon={null} title="Active Copilot Users" text={ActiveCopilot} size="4" info={false} value={[]} />
            </Box>
        </Box>
