...
// PORTFOLIO
export const handlePortfolio = (newPort, input, objDefaultFilter, setPort, setVP, setDirector, setOwner, setAppcode, setExpireDays, setChartState, setVPFilter, setDirectorFilter, setAppOwnerFilter, setAppcodeFilter) => {
  setPort(newPort);
  setVP('All');
  setDirector('All');
  setOwner('All');
...
// VP
export const handleVP = (newVP, input, objDefaultFilter, port, setVP, setDirector, setOwner, setAppcode, setExpireDays, setChartState, setDirectorFilter, setAppOwnerFilter, setAppcodeFilter) => {
  setVP(newVP);
  setDirector('All');
  setOwner('All');
  setAppcode('All');
...
// DIRECTOR
export const handleDirector = (newDirector, input, objDefaultFilter, filterData, setDirector, setOwner, setAppcode, setExpireDays, setChartState, setAppOwnerFilter, setAppcodeFilter) => {
...
// APP OWNER
export const handleOwner = (newOwner, input, objDefaultFilter, filterData, setOwner, setAppcode, setExpireDays, setChartState, setAppcodeFilter) => {
  setOwner(newOwner);
  setAppcode('All');
  setExpireDays('All');
...
// APP CODE
export const handleAppcode = (newAppcode, filterData, setAppcode, setExpireDays, setChartState) => {
...
// EXPIRE DAYS
export const handleExpire = (newExpire, setExpireDays) => {
  setExpireDays(newExpire);
  if (newExpire === 'All' || !newExpire) {
    setExpireDays('All');
  }
};