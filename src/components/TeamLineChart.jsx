...
const TeamLineChart = ({ chartData, type, colorNames, marginCss, legendX, legendY, maxValue, XaxisRotate, legendTextBottom, legendTextRight, legendXOffset, legendWidth }) => {
  ...
  return (
    <>
      <ResponsiveLine
        ...
        colors={type ? colorNames : (d) => d.color}  
